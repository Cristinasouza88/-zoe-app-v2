export const TRILHA_NIIL = [
  {
    ...
    etapas:[
      ...
      {id:'m1-valores',tipo:'micro',titulo:'O que isso representa para você?',min:2,interacao:'voice',chave:'meta-significado',pergunta:'Pense um pouco. O que essa mudança representa para você?',placeholder:'Escreva com as suas palavras. Uma ou duas frases bastam.',pontos:10},
      {id:'m1-sentido-espelho',tipo:'micro',titulo:'O que acontece quando você lê isso?',min:2,interacao:'voice',chave:'meta-significado-sentimento',pergunta:'Agora releia o que você escreveu. O que você sente ao ler isso?',placeholder:'Eu me sinto assim porque…',pontos:10},
