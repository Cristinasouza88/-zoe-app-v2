export const TRILHA_NIIL = [
  {
    ...
    etapas:[
      ...
      {id:'m1-importa',tipo:'micro',titulo:'Quanto isso importa?',min:1,interacao:'scale',chave:'meta-importancia',pergunta:'Hoje, quanto isso realmente importa para você?',minimo:'Pouco',maximo:'Muito',pontos:5,reflexao:'Antes de dar a nota, se pergunte: se nada mudasse nessa área nos próximos meses, quanto isso continuaria ocupando espaço na sua cabeça?'},
      {id:'m1-motivo',tipo:'micro',titulo:'Por que isso importa?',min:1,interacao:'motivation-why',chave:'meta-motivo',pergunta:'Encontre a razão que é sua — não a que parece certa.',pontos:10,reflexao:'Não procure a resposta mais bonita. Pense no que ficaria diferente na sua vida se isso começasse a melhorar.'},
      {id:'m1-recompensa',tipo:'micro',titulo:'O que você ganha de verdade?',min:1,interacao:'reward-choice',chave:'meta-recompensa',pergunta:'Se isso mudar, o que você ganha de verdade?',pontos:10,reflexao:'Tente ir além do resultado visível. Pense no que essa mudança permitiria sentir, escolher ou viver de outro jeito.'},
      {id:'m1-valores',tipo:'micro',titulo:'O que isso representa para você?',min:2,interacao:'meaning-open',chave:'meta-significado',pergunta:'Pense um pouco. O que essa mudança representa para você?',placeholder:'Escreva com as suas palavras. Uma ou duas frases bastam.',pontos:10},
      {id:'m1-sentido-espelho',tipo:'micro',titulo:'O que acontece quando você lê isso?',min:2,interacao:'meaning-feeling',chave:'meta-significado-sentimento',pergunta:'Agora releia o que você escreveu. O que você sente ao ler isso?',placeholder:'Eu me sinto assim porque…',pontos:10},
      {id:'m1-contraste',tipo:'micro',titulo:'Hoje × onde você quer chegar',min:2,interacao:'contrast',chave:'meta-contraste',pergunta:'Sem montar um plano ainda: onde você sente que está e onde gostaria de chegar?',pontos:10},
      ...
      {id:'m1-sintese',tipo:'micro',titulo:'Seu ponto de partida',min:2,interacao:'m1-insight',chave:'m1-sintese-confirmada',pergunta:'Insight NIIL',pontos:15},
      {id:'m1-primeiro-movimento',tipo:'micro',titulo:'Um movimento. Só um.',min:2,interacao:'first-movement',chave:'m1-primeiro-movimento',pergunta:'Qual é a menor evidência de movimento que faz sentido agora?',pontos:20},
    ]
  },
  {
