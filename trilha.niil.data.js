export const TRILHA_NIIL = [
  {
    ...
    etapas:[
      ...
      {id:'m1-valores',tipo:'micro',titulo:'O que isso representa para você?',min:1,interacao:'multi',chave:'meta-valores',pergunta:'Escolha até duas coisas que essa mudança representa para você.',opcoes:['Liberdade','Segurança','Autonomia','Confiança','Tranquilidade','Crescimento','Conexão','Vitalidade','Pertencimento','Realização'],limite:2,pontos:10},
