...
export default defineConfig({
  ...
  plugins: [storageIndexedDb(), persistenciaZoe(), financeiroFluxoDireto(), financeiroCategoriasDetalhe(), financeiroConciliacaoPermanente(), financeiroProdutoIntegrado(), financeiroFluxoPatrimonialV3(), financeiroFluxoPatrimonialV4(), financeiroTrilhaDocumentos(), financeiroTrilhaVisualV2(), financeiroMoedaFocus(), campoPrefixo(), zoeOrbAnimado(), react()],
  base: './'
});
